...
Below is R code to generate some preliminary analyses of tree measurements.
...
Using a paired sample t-test, we see that the average difference within each pair is `r treeDiff(y="Height (m)")$estimate`.  Result is significant.
